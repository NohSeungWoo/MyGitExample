...
public class Assume_unchanged_8 {
	...
	/*
	   ...
	   3. Commit 을 하고 Push 도 합니다. 
		  Web 의 git Hub 에 가보면 /MyGitExample/src/unchaged_assume/Assume_unchanged_8.java 파일이 Push 되어 보여집니다.
	   ...
	   6. 이제부터 Assume_unchanged_8.java 파일은 내용물에 실제로 변경이 있음에도 불구하고
	      ...
	      Assume_unchanged_8.java 파일이 없어져 안보이게 되고, 그럼으로  Staged Changes(관리를 받는 단계)에도 들어오지 않게 되기에 
